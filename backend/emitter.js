...
const generateRandomMessage = () => {
  ...
  const sumCheckMessage = { ...originalMessage, secret_key: calculatedSecretKey };

  try {
    const encryptedMessage = encrypt(Buffer.from(JSON.stringify(sumCheckMessage)), key, iv);
    console.log('Generated Encrypted Message:', encryptedMessage.toString('base64'));
