...
mongoose.connect('mongodb+srv://nutankumari211:nutan%40123%40@cluster0.pmxpstx.mongodb.net/socketDB?retryWrites=true&w=majority', {
...
const decrypt = (text, key, iv) => {
  try {
    ...
    const decryptedText = Buffer.concat([decipher.update(bufferText), decipher.final()]);
